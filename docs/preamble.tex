...
\setminted[bash]{fontfamily=tt,fontsize=\small,xleftmargin=1.25cm,breaklines=true,tabsize=2}
\setminted[text]{fontfamily=tt,fontsize=\small,xleftmargin=1.25cm,breaklines=true,tabsize=2}
